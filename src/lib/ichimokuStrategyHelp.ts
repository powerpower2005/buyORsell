...
export const ICHIMOKU_STRATEGY_HELP: Record<IchimokuStrategyId, HelpContent> = {
  ichi_tk_cross: {
    ...
    howToFind:
      "빨간 전환선이 파란 기준선을 아래에서 위로 뚫으면 호전(롱), 위에서 아래로 뚫으면 역전(숏). 종가가 기준선 위·기준선 상승 중이면 호전 신뢰도가 커집니다. 이평 단기/장기 골든·데드와 같은 틀입니다(실전에서는 이미 중반인 경우 많음).",
    ...BREAK,
    ...
    pros:
      "이평 교차식 추세 전환을 일목 안에서 확인합니다. 기준선 방향·종가 위치로 가짜 교차를 줄입니다.",
    cons:
      "후행·횡보 휩쏘가 있고, 골든처럼 5~6부 능선 확인인 경우가 많습니다. 기준선 횡보 때 신뢰↓.",

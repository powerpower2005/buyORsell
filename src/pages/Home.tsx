...
export function HomePage() {
  ...
  const journalEntries = useMemo(
    () => (ticker ? listJournalEntries(ticker, timeframe) : []),
    [ticker, timeframe, journalTick],
  );
  ...
  const evaluation = useMemo(
    () =>
      quote
        ...
        : null,
    [quote, timeframe, indicatorConfig, trendlineAlgo],
  );
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-stretch">
                  <div className="min-w-0 w-full flex-1 lg:min-h-0">
                    <CandleChart
                      ...
                      chartStochStrategyVisibility={chartStochStrategyVisibility}
